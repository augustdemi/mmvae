...
class DIGIT(Dataset):
    ...
    def __getitem__(self, index):
        ...
        """
        mnist_img, fmnist_img = self.input_a[index], self.input_b[index]

        mnist_img = Image.fromarray(mnist_img, mode='L')
        mnist_img = self.transformA(mnist_img)

        fmnist_img = Image.fromarray(fmnist_img, mode='L')
        fmnist_img = self.transformA(fmnist_img)
        ...
        return mnist_img, fmnist_img, index
