...
class EncoderA(nn.Module):
    ...
    def __init__(self, zPrivate_dim=3, zShared_dim=5, channel=1):
        ...
        self.fc6 = nn.Linear(256, 2*zPrivate_dim + zShared_dim)
...
class EncoderC(nn.Module):
    ...
    def __init__(self, zPrivate_dim=3, zShared_dim=5, channel=1):
        ...
        self.fc4 = nn.Linear(32*4*4, 256)
        self.fc5 = nn.Linear(256, 256)
        self.fc6 = nn.Linear(256, 2*zPrivate_dim)
...
class DecoderC(nn.Module):
    ...
    def __init__(self, zPrivate_dim=3, zShared_dim=5, channel=1):
        ...
        self.fc1 = nn.Linear(zPrivate_dim, 256)
        self.fc2 = nn.Linear(256, 256)
        self.fc3 = nn.Linear(256, 32 * 4 * 4)
        self.weight_init()
    ...
    def forward(self, zPrivate):
        out = F.relu(self.fc1(zPrivate))
        out = F.relu(self.fc2(out))
        out = F.relu(self.fc3(out))
        out = out.view(out.size(0), 32, 4, 4)
        x_recon = self.hallucinate(out)
